									...
									<?php foreach ($tbl_vi as $row){ ?>
										<div class="ap-class-3-3-6-12">
											<div class="card">
												<br>
												<div class="card-body">
													<h6 class="card-title"> <center> <?= $row -> visitante_vi ?> </center> </h6>
													<hr>
													<span> <span class="fas fa-clock"> </span> <small> <?= $row -> hora_vi ?> </small> </span> <br>
													<span> <span class="fas fa-calendar-alt"> </span> <small> <?= $row -> fecha_vi ?> </small> </span> <br>
													<span> <span class="fas fa-edit"> </span> <small> <?= $row -> motivo_vi ?> </small> </span> <br>
												</div>
											</div>
											<br>
										</div>
