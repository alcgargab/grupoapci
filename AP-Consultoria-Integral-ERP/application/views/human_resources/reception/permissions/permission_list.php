									...
									<?php foreach ($tbl_p as $row){ ?>
										<div class="ap-class-3-3-6-12">
											<div class="card">
												<br>
												<center>
													<img class="card-img-top" src="<?= base_url()?>images/Empleado/<?= $tbl_em -> ruta_em ?>/<?= $row -> foto_empleado_e ?>" alt="AP-Consultoria-Integral-ERP" style="width:50%">
												</center>
												<div class="card-body">
													<h6 class="card-title">
														<center> <?= $row -> apellido_paterno_e. " ". $row -> apellido_materno_e . " ". $row -> nombre_e ?> </center>
													</h6>
													<hr>
													<span> <span class="fas fa-clock"> </span> <b> De: <small> <?= $row -> inicio_p ?> </small> </b> </span> <br>
													<span> <span class="fas fa-clock"> </span> <b> A: </b> <small><?= $row -> fin_p ?> </small> </span>
												</div>
											</div>
											<br>
										</div>
