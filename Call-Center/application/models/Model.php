...
class Model extends CI_Model{
  ...
  public function InsertFor($tabla = NULL, $data = NULL, $phone = NULL){
    $total = count($phone);
    $respuesta = array();
    for ($i = 0; $i < $total; $i++) {
      $data['ET_IdU'] = $data['ET_IdU'];
      $data['ET_IdNT'] = $phone[$i] -> IdNT;
      $query = $this -> db -> insert($tabla, $data);
    }
    if ($query) {
      return "ok";
  ...
  // --------------- ACTUALIZAMOS EL ESTATUS DE ASIGNADO A LOS TELÉFONOS ---------------//
  public function updateFor($tabla = NULL, $camposet = NULL, $valor = NULL, $campo = NULL, $phone){
    $total = count($phone);
    $respuesta = array();
    for ($i = 0; $i < $total; $i++) {
      $ruta = $phone[$i] -> IdNT;
  ...
  public function GetAllGroup($tabla = NULL, $campo = NULL){
    $respuesta = array();
    $query = $this -> db -> query("SELECT * FROM $tabla GROUP BY $campo");
    if ($query -> num_rows() > 0) {
      foreach ($query -> result() as $row) {
        $respuesta[] = $row;
      }
  ...
  // --------------- OBTENER TODOS LOS REGISTROS COMPARANDO UN CAMPO ---------------//
  public function GetAllWhere3Diferent($tabla = NULL, $campo1 = NULL, $valor1 = NULL, $campo2 = NULL, $valor2 = NULL, $campo3 = NULL, $valor3 = NULL){
    $respuesta = array();
    $query = $this -> db -> query("SELECT * FROM $tabla WHERE $campo1 != '".$valor1."' AND ($campo2 != '".$valor2."' AND $campo3 != '".$valor3."')");
    if ($query -> num_rows() > 0) {
      foreach ($query -> result() as $row) {
  ...
  // --------------- OBTENER TODOS LOS REGISTROS COMPARANDO DOS CAMPS --------------- //
  public function GetAllWhereFor2($tabla = NULL, $campo1 = NULL, $valor1 = NULL, $posicion = NULL, $campo2 = NULL, $valor2 = NULL){
    if ($valor1 != 0) {
      $total = count($valor1);
      $respuesta = array();
      for ($i = 0; $i < $total; $i++) {
        $query = $this -> db -> query("SELECT * FROM $tabla WHERE $campo1 = '".$valor1[$i] -> $posicion."' AND $campo2 = '".$valor2."'");
        if ($query -> num_rows() > 0) {
          foreach ($query -> result() as $row) {
            $respuesta[] = $row;
          }
  ...
  public function GetAllLimit($tabla = NULL, $base = NULL, $tope = NULL){
    $respuesta = array();
  ...
  // --------------- AGRUPAR TODOS LOS RESULTADOS DE DOS TABLAS COMPARANDO DOS CAMPOS --------------- //{
  public function GetAllInnerWhere2($tabla1 = NULL, $alias1 = NULL, $tabla2 = NULL, $alias2 = NULL, $campo1 = NULL, $campo2 = NULL, $campo3 = NULL, $valor2 = NULL, $valor3 = NULL, $posicion = NULL){
    if ($valor2 != 0) {
      $total = count($valor2);
      $respuesta = array();
      for ($i = 0; $i < $total; $i++) {
        $query = $this -> db -> query("SELECT * FROM $tabla1 $alias1 INNER JOIN $tabla2 $alias2 ON $alias1.$campo1 = $alias2.$campo2 WHERE $alias2.$campo3 = '".$valor3."' AND $alias2.$campo2 = '".$valor2[$i] -> $posicion."'");
        if ($query -> num_rows() > 0) {
          foreach ($query -> result() as $row) {
            $respuesta[] = $row;
          }
  ...
  // --------------- OBTENER REGISTROS AGRUPADOS CON LIKE COMPARANDO 2 CAMPOS ---------------//
  public function GetAllGroupBy($count = NULL, $alias = NULL, $campo = NULL, $tabla = NULL, $groupfor = NULL){
    $respuesta = array();
    $query = $this -> db -> query("SELECT COUNT($count) as $alias, $campo FROM $tabla GROUP BY $groupfor");
    if ($query -> num_rows() > 0) {
      foreach ($query -> result() as $row) {
        $respuesta[] = $row;
      }
  ...
  public function GetAllWhereLikeGroupBy($count = NULL, $alias = NULL, $campo = NULL, $tabla = NULL, $campow = NULL, $valor = NULL, $groupfor = NULL){
    $respuesta = array();
  ...
  // --------------- OBTENER REGISTROS AGRUPADOS CON LIKE COMPARANDO 2 CAMPOS ---------------//
  public function GetAllWhereAndLikeGroupBy($count = NULL, $alias = NULL, $campo = NULL, $tabla = NULL, $campow = NULL, $valor = NULL, $campo2 = NULL, $valor2 = NULL, $groupfor = NULL){
    $respuesta = array();
    $query = $this -> db -> query("SELECT COUNT($count) as $alias, $campo FROM $tabla WHERE $campow LIKE '%$valor%' AND $campo2 = '".$valor2."' GROUP BY $groupfor");
    if ($query -> num_rows() > 0) {
      foreach ($query -> result() as $row) {
        $respuesta[] = $row;
      }
  ...
  public function GetAllWhereGroupBy($count = NULL, $alias = NULL, $campo = NULL, $tabla = NULL, $campow = NULL, $valor = NULL, $groupfor = NULL){
    $respuesta = array();
