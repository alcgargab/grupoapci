							...
							<div class="row">
								...
								<div class="col-lg-3 col-md-3 col-sm-3 col-12">
									...
									<div id="SerachE" class="collapse">
										<form class="" onsubmit="return ValidarBusquedaE()" action="<?= base_url()?>Supervisor/ver-seguimiento-de-llamadas/buscar-por-ejecutivo" method="post">
								...
								<div class="col-lg-7 col-md-7 col-sm-7 col-12">
									...
									<div id="SerachEF" class="collapse">
										<form class="" onsubmit="return ValidarBusquedaET()" action="<?= base_url()?>Supervisor/ver-seguimiento-de-llamadas/buscar-por-ejecutivo-y-fecha" method="post">
