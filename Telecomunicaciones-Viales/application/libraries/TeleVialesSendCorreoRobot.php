<?php
  ...
  class TeleVialesSendCorreoRobot{
          ...
          <body style="padding: 30px;">
            <center>
              <table style="width: 80%; height: 50%; padding: 50px; border: 5px solid rgb(55, 87, 164); border-radius: 20px; background-color: #f7fafb;">
                ...
                <tr>
                  <td>
                  <p style="color: rgb(72, 112, 138); font-size: 20px; font-weight: 100;"> Hola <span style="color: rgb(29, 71, 98); font-size: 30px; font-weight: 100;">' .$data['Usuario'].'</span> buen día. </p>
                  <p style="color: rgb(72, 112, 138); font-size: 20px; font-weight: 100;"> Hemos recibido tus comentarios. </p>
                  <p style="color: rgb(72, 112, 138); font-size: 20px; font-weight: 100;"> En breve recibirás noticias de nosotros. </p>
                  <br> <br>
                  <p style="color: rgb(29, 71, 98); font-size: 30px; font-weight: 100;"> ¿Ya conoces todos nuestros servicios? </p>
                  <ul>
                  <li style="color: rgb(29, 71, 98); font-size: 15px; font-weight: 100;"> Visita nuestros servicios <a href="https://televiales.net/" target="_blank" style="color: rgb(78, 148, 193); font-size: 18px;"> Aquí </a> </li>
                  </ul>
                  </td>
                </tr>
                <tr>
