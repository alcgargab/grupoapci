            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="<?= base_url()?>Buscador/<?php if ($subCatP == "lo-mas-vendido") {
              ...
              <?php if ($orden != NULL) {?>
                <li class="pagActual breadcrumb-item active">
                  <?php if ($subCatP == "lo-mas-vendido") { ?>
                    <a href="<?= base_url()?>Productos/lo-mas-vendido"> <?php print_r("lo más vendido"); ?> </a>
                  <?php }elseif ($subCatP == "lo-mas-visto") {?>
                      <a href="<?= base_url()?>Productos/lo-mas-visto"> <?php print_r("lo más visto"); ?> </a>
                    <?php }else { ?>
                      <a href="<?= base_url()?>"> <?php print_r($subCatP -> Ruta); ?> </a>
                    <?php } ?>
                </li>
                <li class="pagActual breadcrumb-item active">
                  <?php if ($orden == "mas-reciente") {
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  ...
                  <?php foreach ($producto as $row) { ?>
                    ...
                    <li class="col-lg-3 col-md-3 col-sm-6 col-xs-12 ListProd">
                      <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                          <input type="text" name="" value="<?= $row -> Vistas?>">
                          <figure>
                    ...
                    <?php }elseif ($pagProductos <= 5) { ?>
                      <ul class="pagination justify-content-center">
                        <?php for ($i=1; $i <= $pagProductos; $i++) { ?>
                          <li class="page-item <?php echo $base == $i ? 'active' : '' ?>"> <a class="page-link" href="<?= base_url()?>Buscador/<?php if (isset($subCatP -> idSubCat)) { print_r($subCatP -> idSubCat); }else {print_r($subCatP);} ?>/<?= $orden ?>/<?= $i ?>"><?php print_r($i); ?> </a> </li>
                        <?php } ?>
                      </ul>
                    <?php }else { ?>
                      <ul class="pagination justify-content-center">
                        <li class="page-item <?php echo $base <= 1 ? 'disabled' : '' ?>"><a class="page-link" href="<?= base_url()?>Buscador/<?php if (isset($subCatP -> idSubCat)) { print_r($subCatP -> idSubCat); }else {print_r($subCatP);} ?>/<?= $base -1 ?>">Previus</a></li>
                        <?php for ($i=1; $i <= $pagProductos-4; $i++) { ?>
                          <li class="page-item <?php echo $base == $i ? 'active' : '' ?>"><a class="page-link" href="<?= base_url()?>Buscador/<?php if (isset($subCatP -> idSubCat)) { print_r($subCatP -> idSubCat); }else {print_r($subCatP);} ?>/<?= $i ?>"><?php print_r($i); ?></a></li>
                        <?php } ?>
                        <li class="page-item disabled"> <a class="page-link" href="#">...</a> </li>
                        <li class="page-item <?php echo $base == $i+1 ? 'active' : '' ?>"><a class="page-link" href="<?= base_url()?>Buscador/<?php if (isset($subCatP -> idSubCat)) { print_r($subCatP -> idSubCat); }else {print_r($subCatP);} ?>/<?= $pagProductos ?>"><?php print_r($pagProductos); ?></a></li>
                        <li class="page-item <?php echo $base >= $pagProductos ? 'disabled' : '' ?>"><a class="page-link" href="<?= base_url()?>Buscador/<?php if (isset($subCatP -> idSubCat)) { print_r($subCatP -> idSubCat); }else {print_r($subCatP);} ?>/<?= $base +1 ?>">Next</a></li>
                      </ul>
                    <?php }
