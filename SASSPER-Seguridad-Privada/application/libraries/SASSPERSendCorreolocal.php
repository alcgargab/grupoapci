  ...
  class SASSPERSendCorreolocal{
    ...
    // echo '<pre>'; print_r($datos_mail['txtbody']); echo '</pre>'; die();
      ...
      // try {
        ...
        $mail -> addCC('desarrollo@apci.com.mx', 'S.ASSPER Seguridad Privada');
        // SE ENVIA UNA COPIA OCULTA AL SIGUIENTE CORREO
        $mail -> addBCC('desarrollo@apci.com.mx', 'Ventas de S.ASSPER');
        // $mail -> addBCC('asis_seguridad@sassper.net', 'Asistente de S.ASSPER');
          ...
          <body style="padding: 30px;">
            <center>
              <table style="width: 80%; height: 50%; padding: 50px; border: 5px solid #ffd556; border-radius: 20px; background-color: #ffffff;">
                ...
                <tr>
                  <td>
                    <p style="	color: #ffd556; text-align:center; font-size: 50px;">Comentarios de Cliente</p>
                  </td>
                </tr>
                <tr>
                  <td>
