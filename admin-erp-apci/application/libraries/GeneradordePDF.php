<?php
  ...
  class GeneradordePDF {
    ...
    // --------------- GENERAR FORMATO DE PERMISOS --------------- //
    public function GenerarPermiso($data = NULL){
          ...
          <center>
            ...
            <table style="width: 100%">
              <tr>
                ...
                <td style="width: 30%">
                  <center>
                    <p style="font-size: 10px; text-transform: uppercase; font-size: 10px;"> chavez ruth <br> _______________________________ </p>
                    <p style="text-transform: uppercase; font-size: 10px; font-weight: bold;"> gerente general </p>
                  </center>
                </td>
              </tr>
            </table>
    ...
    // --------------- GENERAR FORMATO DE PERMISOS URGENTES --------------- //
    public function GenerarPermisoUrgente($data = NULL){
      $txtbody = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
      <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es-es" lang="es-es">
      	<head>
      		<title></title>
    ...
    public function GenerarVacaciones($data = NULL){
    ...
    public function generarEvaluacion($data = NULL){
      $total = $data['evaluacion'] -> Comunicacion + $data['evaluacion'] -> TolFru + $data['evaluacion'] -> Autocontrol +
              $data['evaluacion'] -> Motivacion + $data['evaluacion'] -> Adaptacion + $data['evaluacion'] -> Seguridad +
              $data['evaluacion'] -> Creatividad + $data['evaluacion'] -> Cooperacion + $data['evaluacion'] -> ApNormas +
              $data['evaluacion'] -> VisCom + $data['evaluacion'] -> Planeacion + $data['evaluacion'] -> Organizacional +
              $data['evaluacion'] -> SegInst + $data['evaluacion'] -> Liderazgo + $data['evaluacion'] -> Responsabilidad +
              $data['evaluacion'] -> EjSim + $data['evaluacion'] -> Confiabilidad + $data['evaluacion'] -> ResSocial +
              $data['evaluacion'] -> ManCon + $data['evaluacion'] -> RenPre + $data['evaluacion'] -> TraEqui +
              $data['evaluacion'] -> Asertividad + $data['evaluacion'] -> Empuje;
              $bandera = $total / 23;
              $cal = number_format($bandera, 2, '.', '');
                ...
                <td>
                  <table>
                    <tr>
                      <td style="width: 30%">
                        <center>
                          <img src="./images/Logos/ERP_logo_RHEO.png" alt="Logo de Recursos Humanos Eficacia Organizacional" width="150px">
                        </center>
                      </td>
                      <td style="width: 70%">
                        <center>
                    ...
                    <tr>
                      <td style="width: 80%">
                        <table>
                          <tr>
                            <td style="width: 50%">
                              <span style="text-transform: uppercase; text-align: left; font-size: 10px;"> <b> Nombre: </b> '.$data["empleado"] -> ApellidoPEmp.' '.$data["empleado"] -> ApellidoMEmp.' '.$data["empleado"] -> NomEmp.' </span>
                            </td>
                            <td style="width: 50%">
                              <span style="text-transform: uppercase; text-align: left; font-size: 10px;"> <b> Depto: </b> '.$data['area'] -> Area.' </span>
                            </td>
                          </tr>
                          <tr>
                            <td style="width: 50%">
                              <span style="text-transform: uppercase; text-align: left; font-size: 10px;"> <b> puesto: </b> '.$data["puesto"] -> Puesto.' </span>
                            </td>
                            <td style="width: 50%">
                              <span style="text-transform: uppercase; text-align: left; font-size: 10px;"> <b> fecha de ingreso: </b> '.$data['empleado'] -> FIngresoEmp.' </span>
                            </td>
                          </tr>
                          <tr>
                            <td style="width: 50%">
                              <span style="text-transform: uppercase; text-align: left; font-size: 10px;"> <b> fecha de evaluación: </b> '.$data["evaluacion"] -> FEvaluacion.' </span>
                            </td>
                            <td style="width: 50%">
                              <span style="text-transform: uppercase; text-align: left; font-size: 10px;"> <b> evaluador: </b> '.$data['empresa'] -> JInmediato.' </span>
                            </td>
                          </tr>
                        </table>
                      </td>
                      <td style=" width: 10%; text-transform: uppercase; text-align: center; padding: 10px; font-size: 10px; font-weight: bold" valign="top">
                        <center>
                          ...
                          <span style="font-size: 13px;"> '.$cal.' </span>
                        </center>
                      </td>
                    </tr>
                  </table>
                  <table>
                    ...
                    <tr>
                      ...
                      <td style="width: 10%; text-align: center; font-size: 10px; border: 1px solid #000000; text-transform: uppercase; font-weight: bold;">
                        '.$data['evaluacion'] -> Cooperacion.'
                      </td>
                    </tr>
                    <tr>
                      <td style="width: 90%; text-align: justify; font-size: 10px; border: 1px solid #000000; padding: 2px 10px 2px;">
                        <b> Apego a normas: </b> Capacidad para entender y cumplir sus obligaciones como '.$data['puesto'] -> Puesto.' en concordancia con la normatividad y reglamentos aplicables.
                      </td>
                      <td style="width: 10%; text-align: center; font-size: 10px; border: 1px solid #000000; text-transform: uppercase; font-weight: bold;">
                        '.$data['evaluacion'] -> ApNormas.'
                      </td>
                    </tr>
                    <tr>
                      <td style="width: 90%; text-align: justify; font-size: 10px; border: 1px solid #000000; padding: 2px 10px 2px;">
                    ...
                    <tr>
                      ...
                      <td style="width: 10%; text-align: center; font-size: 10px; border: 1px solid #000000; text-transform: uppercase; font-weight: bold;">
                        '.$data['evaluacion'] -> Organizacional.'
                      </td>
                    </tr>
                    <tr>
                      <td style="width: 90%; text-align: justify; font-size: 10px; border: 1px solid #000000; padding: 2px 10px 2px;">
                    ...
                    <tr>
                      ...
                      <td style="width: 10%; text-align: center; font-size: 10px; border: 1px solid #000000; text-transform: uppercase; font-weight: bold;">
                        '.$data['evaluacion'] -> Responsabilidad.'
                      </td>
                    </tr>
                    <tr>
                      <td style="width: 90%; text-align: justify; font-size: 10px; border: 1px solid #000000; padding: 2px 10px 2px;">
                  ...
                  <table style="margin-top: 10px;">
                    <tr>
                      <td colspan="2">
                        <center>
                          <p style="font-size: 13px;"> _________________________________________ <br> <b> '.$data["empleado"] -> ApellidoPEmp.' '.$data["empleado"] -> ApellidoMEmp.' '.$data["empleado"] -> NomEmp.' </b> </p>
                        </center>
                      </td>
                    </tr>
                  </table>
      ...
      // print_r($txtbody); die();
      $generarPDF = new Dompdf();
      $filename = $data['evaluacion'] -> CodigoE;
      // $generarPDF -> set_option("isPhpEnabled", true);
      $generarPDF -> loadHtml($txtbody);
      // (Opcional) Configure el tamaño y la orientación del papel
      $generarPDF -> setPaper(' A4 ' , ' landscape ');
    ...
    // --------------- GENERAR FORMATO DE RENUNCIA --------------- //
    public function GenerarRenuncia($doc = NULL, $fRenunciaLetra = NULL, $home = NULL){
      $txtbody = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
      <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es-es" lang="es-es">
      	<head>
      		<title></title>
    ...
    public function GenerarFiniquito($doc = NULL, $fechaActual = NULL, $home = NULL, $rh = NULL){
    ...
    // --------------- GENERAR FORMATO DE LA BAJA DEL IMSS --------------- //
    public function GenerarBajaIMSS($doc = NULL, $fechaActual = NULL, $home = NULL, $rh = NULL){
      echo "<pre>";
      print_r($doc);
      echo "<br>";
      print_r($fechaActual);
    ...
    // --------------- GENERAR CONTRATO TEMPORAL CALL CENTER --------------- //
    public function GenerarContratoCC($empleado = NULL, $salarioLetra = NULL, $fechaActual = NULL, $fechaIngresoLetra = NULL, $fechaProximaFirmaLetra = NULL){
      if ($empleado["empleado"] -> E_idTEmp == 1) {
        $horadeTrabajo = "08:00 a las 14:00";
      }elseif ($empleado["empleado"] -> E_idTEmp == 2) {
        $horadeTrabajo = "14:00 a las 20:00";
      }elseif ($empleado["empleado"] -> E_idTEmp == 3) {
        $horadeTrabajo = "09:00 a las 19:00";
      }else {
        $horadeTrabajo = "24 x 24";
      }
      $txtbody = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
          ...
          <center>
            <table style="width: 100%; text-align: justify;">
              <tr>
                  ...
                  <p> QUE CELEBRAN POR UNA PARTE <b> RH EFICACIA ORGANIZACIONAL, S DE RL DE CV.</b>,  REPRESENTADA EN ESTE ACTO POR EL <b> C. ARMANDO JAVIER FLORES SOTO </b>, A QUIEN  DESIGNAREMOS COMO <b> “EL PATRÓN” </b>, Y POR LA OTRA EL C. <b> '.$empleado["empleado"] -> ApellidoPEmp.' '.$empleado["empleado"] -> ApellidoMEmp.' '.$empleado["empleado"] -> NomEmp.' </b> QUIEN NOMBRAREMOS COMO <b> “EL TRABAJADOR” </b>, MISMO QUE SUJETAN AL TENOR DE LOS SIGUIENTES:</p>
                  ...
                  <p> <b> 1.3.- </b> Que para llevar a cabo el objeto social de su mandante, requiere de la contratación de personal, especialmente en el área de '.$empleado["puesto"] -> Puesto.'. </p>

                  <p> <b> 2.- </b> Declara <b> “EL TRABAJADOR” </b> por su propio derecho y de forma expresa: </p>

                  <p> <b> 2.1.- </b> Que responde al nombre de <b> '.$empleado["empleado"] -> ApellidoPEmp.' '.$empleado["empleado"] -> ApellidoMEmp.' '.$empleado["empleado"] -> NomEmp.'</b>, Es una persona física de nacionalidad <b> MEXICANA </b> por nacimiento, de <b> '.$empleado["empleado"] -> EdadEmp.' </b> años de edad, tiene la capacidad jurídica para contratar y obligarse en este tipo de actos, quien tiene su domicilio en la calle '.$empleado["empleado"] -> CalleEmp.', <b> '.$empleado["empleado"] -> NumExtEmp.' '.$empleado["empleado"] -> NumIntEmp.'</b>,  Col. <b> '.$empleado["empleado"] -> ColoniaEmp.'</b>,  en <b> '.$empleado["empleado"] -> MunicipioEmp.'; </b> con Número de Seguridad Social <b> '.$empleado["empleado"] -> IMSSEmp.'</b>, CLAVE Única de Registro de Población (CURP) <b> '.$empleado["empleado"] -> CURPEmp.' </b> identificándose en este acto con su Credencial de Elector (INE) No.XXXXXXX y/o Pasaporte No XXXXXXXXX. </p>
            ...
            <table style="width: 100%; text-align: justify;">
              <tr>
                  ...
                  <p> <b> SEXTA.-  “EL TRABAJADOR” </b> prestará sus servicios a <b> “EL PATRÓN” </b> dentro de una jornada comprendida de Lunes a Sábado de '.$horadeTrabajo.' horas contando con un descanso de 30 minutos para comer; en la inteligencia que deberá laborar máximo 48 horas como marca la Ley Federal de Trabajo. </p>
            ...
            <table style="width: 100%; text-align: justify;">
              <tr>
                  ...
                  <p> Enteradas las partes del contenido y alcance de las estipulaciones del presente contrato, manifiesta su más entera conformidad y lo firman en la Ciudad de México, DF a '.$fechaActual.'. </p>
          			</td>
              </tr>
            </table>
            <br><br><br><br><br><br>
            <table style="text-align: center">
              <tr>
                <td valign="top">
                  ...
                  <p> _________________________________ <br> <b> '.$empleado["empleado"] -> ApellidoPEmp.' '.$empleado["empleado"] -> ApellidoMEmp.' '.$empleado["empleado"] -> NomEmp.' </b> </p>
                </td>
                <td valign="top">
      ...
      $generarPDF = new  Dompdf();
      $filename =  $empleado['empleado'] -> NumEmp;
      // $generarPDF -> set_option("isPhpEnabled", true);
      $generarPDF -> loadHtml ($txtbody);
      // (Opcional) Configure el tamaño y la orientación del papel
      $generarPDF -> setPaper ( ' A4 ' , ' landscape ' );
      ...
      $crearPDF = $generarPDF -> output();
      //Enviar el PDF generado al navegador
      $salidaPDF = $generarPDF -> stream ('Contrato Parcial'.$filename);
    }
  }
