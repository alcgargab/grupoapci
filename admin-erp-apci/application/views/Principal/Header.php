							...
							if ($this -> session -> validarSesion == "ok") { ?>
								...
								<li class="nav-item dropdown dropleft">
									<a class="nav-link dropdown-toggle" data-toggle="dropdown" href="<?= base_url()?>">
										<img src="<?= base_url()?>images/Empleado/<?= $ruta?>/<?= $empleado -> FotoEmp?>" alt="AP | Consultoría Integral" width="30px" class="rounded-circle">
									</a>
									<div class="dropdown-menu">
										<a class="dropdown-item" href="<?= base_url()?>Admin/<?= $ruta?>/cerrar-sesion"> Cerrar sesión </a>
									</div>
								</li>
							<?php } else { ?>
								<li class="nav-item">
