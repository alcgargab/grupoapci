...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="es-es" lang="es-es">
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url()?>css/Plugins/animate.min.css">
  ...
  <body>
    ...
    <div class="row">
      <div class="col-lg-12">
        <input id="validarSesion" type="hidden" name="" value="<?= $this -> session -> validarSesion ?>" class="form-control">
        <input id="TUSesion" type="hidden" name="" value="<?= $this -> session -> TUSesion ?>" class="form-control">
      </div>
    </div>
